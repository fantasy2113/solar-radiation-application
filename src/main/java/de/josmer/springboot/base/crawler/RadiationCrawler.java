package de.josmer.springboot.base.crawler;

import de.josmer.springboot.base.FileReader;
import de.josmer.springboot.base.interfaces.ISolRad;
import de.josmer.springboot.base.interfaces.ISolRadRepository;
...
public final class RadiationCrawler<TSolRad extends ISolRad> {
    ...
    public void insert(final ISolRadRepository radiationRepository, de.josmer.springboot.base.FileReader fileReader) {
        try {
            download();
            unzip();
    ...
    private void insertRadiation(final ISolRadRepository radiationRepository, FileReader fileReader) throws Exception {
        LOGGER.info("reading...");
    ...
    private void initRadiations(FileReader fileReader) throws Exception {
