package de.josmer.solardb.base.crawler;
...
public final class RadiationCrawler {
    ...
    public void insert(final ISolRadRepository radiationRepository, de.josmer.solardb.base.FileReader fileReader) {
        download();
        unzip();
    ...
    private void insertRadiation(final ISolRadRepository radiationRepository, de.josmer.solardb.base.FileReader fileReader) {
        LOGGER.info("reading...");
