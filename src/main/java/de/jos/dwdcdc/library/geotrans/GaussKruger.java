...
public final class GaussKruger implements IGaussKruger {
    ...
    private void geoToGk() {
        ...
        double ex6 = ex4 * ex2;
        double ex8 = ex4 * ex4;
        double e0 = c * (Math.PI / 180)
                * (1.0 - 3.0 * ex2 / 4.0 + 45.0 * ex4 / 64.0 - 175.0 * ex6 / 256.0 + 11025.0 * ex8 / 16384.0);
        ...
        this.rechtswert = (nd * cos1 * dl + nd * cos3 * (1.0 - tan2 + etasq) * dl3 / 6.0
                + nd * cos5 * (5.0 - 18.0 * tan2 + tan4) * dl5 / 120.0 + kz * 1e6 + 500000.0);
