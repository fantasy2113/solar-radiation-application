...
public class Irradiation {
    ...
    /// </summary>
    /// <param name="Dt"></param>
    private void SetEDirHorExtra(DateTime Dt) {
    ...
    /// <param name="Dt"></param>
    private void SetDelta(double EDiffHor, double EDirHor, double EGlobalHor, DateTime Dt) {
    ...
    public void CalculateHour(double EDiffHor, double EDirHor, double EGlobalHor, DateTime Dt, int DiffModel, double shading) {
        DateTime dateTime = new DateTime(Dt.Year, Dt.Month, Dt.Day, Dt.Hour, Dt.Minute, 0);
