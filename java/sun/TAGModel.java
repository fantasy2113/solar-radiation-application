...
public class TAGModel {
    ...
    public double[] CalculateDay(DateTime day, double hGlob, double lat, double lon) {
        ...
        for (int h = 0; h < 24; h++) {
            DateTime dt = new DateTime(day.Year, day.Month, day.Day, h, day.Minute, 0);
    ...
    private double E0ofDay(DateTime day) {
        // formula 4.4
